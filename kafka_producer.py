...
NUM_CUSTOMERS = random.randint(10,110)
...
# docker exec -it c25955b318e3 kafka-console-consumer --bootstrap-server localhost:9092 --topic yn-customers-0812 --from-beginning --max-messages 10
